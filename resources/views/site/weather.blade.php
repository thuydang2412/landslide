...
<div style="background-color: #FFF; padding: 20px; min-height: 100vh">
    ...
    <div class="row" style="width: 90%; margin: auto;">
        ...
        <div class="prec-search-panel col-md-3 select-layer-panel" style="padding-top: 30px;">
    ...
    <div class="row" style="width: 90%; margin: auto;">
        ...
        <h4 style="font-weight: bold">Thông tin trạm pessl</h4><br/>
        <div class="prec-search-panel col-md-3 select-layer-panel" style="padding-top: 30px;">
            <span class="title">Chọn trạm</span>
            <select id="input-station-pessl" class='form-control' data-placeholder="-- Chọn trạm --"><option></option></select>

            <span class="title md-mt-5">Từ ngày</span>
            <input type="text" class="form-control" id="input-start-date-pessl"></p>
            <span class="title">Đến ngày</span>
            <input type="text" class="form-control" id="input-end-date-pessl"></p>

            <hr/>
            <div>
                <span class="title">Chọn dữ liệu hiển thị</span>
                <label class="check-box-column-label"><input id="check-box-precip-pessl" type="checkbox" value="0" class="check-box-column-type-pessl" checked> Lượng mưa</label>
                <label class="check-box-column-label"><input id="check-box-temp-pessl" type="checkbox" value="1" class="check-box-column-type-pessl"> Nhiệt độ</label>
            </div>

            <hr/>
            <div>
                <span class="title">Chọn loại đồ thị</span>
                <label class="check-box-column-label"><input type="checkbox" value="0" class="check-box-graph-type-pessl"> Lượng mưa</label>
                <label class="check-box-column-label"><input type="checkbox" value="1" class="check-box-graph-type-pessl"> Nhiệt độ</label>
            </div>

            <button type="button" id="btn-search-pessl" class="btn btn-primary btn-block md-mt-15">Xem dữ liệu</button>
        </div>

        <div class="col-md-9">
            <table id="tbl-data-pessl" class="table table-striped table-bordered tbl-data">
                <thead>
                <tr id="tbl-data-row-head">
                    <th>Ngày</th>
                    <th>Giờ</th>
            ...
            {{--Graph Precipmm--}}
            <div id="precipmm-graph-panel-container-pessl" class="collapse md-mt-20">
                <span class="graph-title">Lượng mưa cộng dồn (mm)</span>
                <div id="precipmm-graph-panel-pessl" style="height: 400px; width: 100%;"></div>
            </div>


            {{--Graph Temp--}}
            <div id="temp-graph-panel-container-pessl" class="collapse md-mt-20">
                <span class="graph-title">Nhiệt độ (°C)</span>
                <div id="temp-graph-panel-pessl" style="height: 400px; width: 100%;"></div>
            </div>
...
@if($isAdmin)
<script src="{{ URL::asset('js/weatherPessl.js') }}"></script>
@endif
